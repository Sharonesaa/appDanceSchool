...
const updateStyleService = (id, styleData) => __awaiter(void 0, void 0, void 0, function* () {
    yield data_source_1.StyleModel.update(id, styleData);
    const updatedStyle = yield data_source_1.StyleModel.findOneBy({ id });
    return updatedStyle;
});
exports.updateStyleService = updateStyleService;
const deleteStyleService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    yield data_source_1.StyleModel.delete(id);
});
...
const deactivateStyleService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (style) {
        style.active = false;
        const updatedStyle = yield data_source_1.StyleModel.save(style);
        return updatedStyle;
    }
    else {
